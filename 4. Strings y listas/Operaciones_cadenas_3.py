...
def primeras_letras(cadena: str) -> str:
    ...
    for i in range(longitud):
        ...
        ### Si es un espacio, la variable de caracter inicial se hace True
        elif caracter == " ":
            es_caracter_inicial = True
...
def primera_letra_mayus(cadena: str) -> str:
    ...
    for i in range(longitud):
        ...
        ### Si el caracter es espacio, la variable de caracter inicial se hace True
        elif (caracter == " "):
            es_caracter_inicial = True
            cadena_primeras_mayus += caracter
...
def comienzan_con_a(cadena: str) -> str:
    ...
    for i in range(longitud):
        ...
        ### Si el caracter es espacio, la variable de caracter inicial se hace True
            ...
            es_caracter_inicial = True
            ## Aniado espacios entre palabras que empiezan con A
            if empieza_con_a:
                cadena_palabras_con_a += caracter
            empieza_con_a = False
